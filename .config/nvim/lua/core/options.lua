...
local options = {
    ...
    spell = false,           -- No ignore word with number, only check comments in source code, use 'spellfile', no quick list of all error.  Use cspell.
    ...
    timeout = true,
    timeoutlen = 500,        -- Shorten timeout for jk and kj. Which-key adds timeout when pop-up is shown.
    title = true,
    ...
    fileencodings = "utf-8,gbk,cp936,gb18030,big5,euc-jp,euc-kr,utf-16le,latin1,ucs-bom,ucs", -- Try to decode in this order
